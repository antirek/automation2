...
class StepWorker {
  ...
  constructor (props) {
    ...
    const myQueueScheduler = new QueueScheduler(readyQueueName, {connection});
    this.readyQueue = new Queue(readyQueueName, {connection});
  ...
  async passResultToReadyQueue (stepTask) {
    this.readyQueue.add('ready', stepTask, {removeOnComplete: true, attempts: 3,});
  }
